        ...
        if (requestCode == 102) {
            if (resultCode == RESULT_OK) {
                ...
                if (filePath.endsWith(".xlsx")) {
                    ...
                    Toast.makeText(QuestionsActivity.this, "Correct file", Toast.LENGTH_SHORT).show();
                } else {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    XSSFWorkbook workbook = new XSSFWorkbook(openInputStream);
                                ...
                                if (correctAns.equals(a) || correctAns.equals(b) || correctAns.equals(c) || correctAns.equals(d)) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            loadingDialog.dismiss();
                                            Toast.makeText(QuestionsActivity.this, "Row no." + (finalR + 1) + "NO correct option !", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                    return;
                                }
